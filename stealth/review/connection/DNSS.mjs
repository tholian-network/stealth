...
const CLOUDFLARE = Object.assign(URL.parse('dnss://cloudflare-dns.com:853'), {
	hosts: [
		IP.parse('1.1.1.1'),
...
describe('DNSS.connect()', function(assert) {
	...
	let connection = DNSS.connect(CLOUDFLARE);
...
describe('DNSS.receive()/client/NAMEWRECK', function(assert) {

	assert(isFunction(DNSS.receive), true);

	DNSS.receive(null, NAMEWRECK['RESPONSE'], (request) => {
...
describe('DNSS.receive()/client/A', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['A']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/AAAA', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['AAAA']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/CNAME', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['CNAME']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/MX', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['MX']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/NS', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['NS']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/PTR/v4', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['PTR_IPV4']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/PTR/v6', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['PTR_IPV6']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/SRV', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['SRV']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/client/TXT', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['TXT']['RESPONSE'], (response) => {
...
describe('DNSS.receive()/server/A', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['A']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/AAAA', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['AAAA']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/CNAME', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['CNAME']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/MX', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['MX']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/NS', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['NS']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/PTR/v4', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['PTR_IPV4']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/PTR/v6', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['PTR_IPV6']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/SRV', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['SRV']['REQUEST'], (request) => {
...
describe('DNSS.receive()/server/TXT', function(assert) {
	...
	connection.once('@connect', () => {
		...
		DNSS.receive(connection, PAYLOADS['TXT']['REQUEST'], (request) => {
...
describe('DNSS.send()/client/SRV', function(assert) {
	...
	let connection1 = DNSS.connect(CLOUDFLARE);
	let connection2 = DNSS.connect(CLOUDFLARE);
...
describe('DNSS.receive()/server/NAMEWRECK', function(assert) {

	assert(isFunction(DNSS.receive), true);

	DNSS.receive(null, NAMEWRECK['REQUEST'], (request) => {
