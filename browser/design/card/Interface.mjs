...
const Interface = function(browser, actions) {
	...
	this.element = new Element('browser-card-interface', [
		...
		'</li>',
		'<li>',
		'<input id="browser-card-interface-opentab-' + uid + '-2" name="opentab" type="radio" value="stealth:history">',
		'<label for="browser-card-interface-opentab-' + uid + '-2">Use <a href="stealth:history">stealth:history</a>.</label>',
		'</li>',
		'<li>',
		'<input id="browser-card-interface-opentab-' + uid + '-3" name="opentab" type="radio" value="stealth:search">',
		'<label for="browser-card-interface-opentab-' + uid + '-3">Use <a href="stealth:search">stealth:search</a>.</label>',
		'</li>',
		'<li>',
		'<input id="browser-card-interface-opentab-' + uid + '-4" name="opentab" type="radio" value="stealth:blank">',
		'<label for="browser-card-interface-opentab-' + uid + '-4">Use <a href="stealth:blank">stealth:blank</a>.</label>',
		'</li>',
		'</ul>',
		'</browser-card-interface-article>',
