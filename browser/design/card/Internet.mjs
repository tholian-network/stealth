...
const Internet = function(browser, actions) {
	...
	this.element = new Element('browser-card-internet', [
		...
		'</li>',
		'<li>',
		'<input id="browser-card-internet-connection-' + uid + '-4" name="connection" type="radio" value="i2p">',
		'<label for="browser-card-internet-connection-' + uid + '-4">This machine has proxied internet access via <abbr title="Invisible Internet Project">I2P</abbr>.</label>',
		'</li>',
		'<li>',
		'<input id="browser-card-internet-connection-' + uid + '-5" name="connection" type="radio" value="tor">',
		'<label for="browser-card-internet-connection-' + uid + '-5">This machine has proxied internet access via <abbr title="The Onion Router">TOR</abbr>.</label>',
		'</li>',
		'</ul>',
		'<h4>Internet History</h4>',
		'<p>Stealth can remember the Internet History. It is remembered per-Peer and per-Tab and kept until below condition is matched.</p>',
		...
		'</li>',
		'<li>',
		'<input id="browser-card-internet-history-' + uid + '-4" name="history" type="radio" value="forever">',
		'<label for="browser-card-internet-history-' + uid + '-4">Remember history forever.</label>',
		'</li>',
		'</ul>',
